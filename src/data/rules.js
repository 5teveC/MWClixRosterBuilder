...
//------Shared Rules-----
// Some rules are shared across multiple types, so we define them once and reuse them.
const sharedSpeedRules = {
  green: {
...
const sharedHeatRules = {
  green: {
    name: "Starting Position",
    text: "At the beginning of the game, this unit must have this green square showing on its heat dial.",
  },
  yellow: {
    name: "Avoid Shutdown",
    text: "If this unit is not shutdown, roll one six-sided die. On a result of 1 or 2, this unit is marked so that it has two order tokens. (Optional) If this unit is shutdown, roll one six-sided die. On a result of 3–6, this unit restarts.",
  },
  red: {
    name: "Avoid Shutdown: CRITICAL",
    text: "If this unit is not shutdown, roll one six-sided die. On a result of 1–3, this unit is marked so that it has two order tokens. (Optional) If this unit is shutdown, roll one six-sided die. On a result of 4–6, this unit restarts.",
  },
  black: {
    name: "Engine Overheat",
    text: "This unit cannot use speed special equipment or the run option.",
  },
};
...
const rules = {
  ...
  damage: {
    ...
    aquaticSpeed: sharedSpeedRules,
    footSpeed: sharedSpeedRules,
    hoverSpeed: sharedSpeedRules,
    trackedSpeed: sharedSpeedRules,
    vtolSpeed: sharedSpeedRules,
    mechSpeed: sharedSpeedRules,
    quadSpeed: sharedSpeedRules,
    wheeledSpeed: sharedSpeedRules,
  },
  ...
  heat: {
    ballisticDamage: {
      ...
      yellow: {
        name: "Avoid Ammunition Explosion",
        text: "If this unit is not shutdown, roll one six-sided die. On a result of 1 or 2, this unit is dealt pushing damage equal to its damage value with the (BALLISTIC) range type –1, minimum 0.",
      },
      red: {
        name: "Avoid Ammunition Explosion: CRITICAL",
        text: "If this unit is not shutdown, roll one six-sided die. On a result of 1–3, this unit is dealt pushing damage equal to its damage value with the (BALLISTIC) range type +1.",
      },
      black: {
        name: "Ammunition Jam",
        text: "This unit cannot use special equipment with the (BALLISTIC) range type or make ranged combat attacks using the (BALLISTIC) range type.",
      },
    },
    energyDamage: {
      green: {
      ...
      yellow: {
        name: "Avoid Heat Sink Overload",
        text: "If this unit is not shutdown, roll one six-sided die. On a result of 1 or 2, this unit gains 1 heat.",
      },
      red: {
        name: "Avoid Heat Sink Overload: CRITICAL",
        text: "If this unit is not shutdown, roll one six-sided die. On a result of 1–3, this unit gains 2 heat.",
      },
      black: {
        name: "Weapons Offline",
        text: "This unit cannot use special equipment with the (ENERGY) range type or make ranged combat attacks using the (ENERGY) range type.",
      },
    },

    aquaticSpeed: sharedHeatRules,
    footSpeed: sharedHeatRules,
    hoverSpeed: sharedHeatRules,
    trackedSpeed: sharedHeatRules,
    vtolSpeed: sharedHeatRules,
    mechSpeed: sharedHeatRules,
    quadSpeed: sharedHeatRules,
    wheeledSpeed: sharedHeatRules,
  },
};
